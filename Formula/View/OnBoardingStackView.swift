...
//  Formula
//
//  Created by Pedro on 4/19/19.
//  Copyright © 2019 Pedro. All rights reserved.
//

import UIKit

class OnBoardingStackView: UIStackView {
  ...
  let searchImage = UIImageView(image: #imageLiteral(resourceName: "searchOn"))
  let searchContainer = UIView()
  
  //Favorite
  let favoriteInfo = UILabel(text: "Favorite your most used formulas and delete by long pressing")
  let favoriteImage = UIImageView(image: #imageLiteral(resourceName: "fav.pdf"))
  let favoriteContainer = UIView()
  
  //Clean
  let cleanInfo = UILabel(text: "Clean and straight forward design")
  let cleanImage = UIImageView(image: #imageLiteral(resourceName: "thumbup.pdf"))
  ...
  func setupStackViews() {
    [searchImage, favoriteImage, cleanImage].forEach({$0.translatesAutoresizingMaskIntoConstraints = false})
    ...
    [masterVerticalStackView, continueButton].forEach({addSubview($0)})
    masterVerticalStackView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: 0.80).isActive = true
    ...
    continueButton.anchor(top: nil, leading: masterVerticalStackView.leadingAnchor, bottom: safeAreaLayoutGuide.bottomAnchor, trailing: masterVerticalStackView.trailingAnchor, padding: .init(top: 0, left: 0, bottom: 40, right: 0))
    infoVerticalStackView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.40).isActive = true
  }
